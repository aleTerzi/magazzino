...
class StepperClass
{
    ...
    */
    ...
    stepperMotor x_stepper_motor = {22, 23, 14, 19, false, 0, true, true, DEFAULT_SPEED_X, DEFAULT_SHIFT_XY};
    stepperMotor y_stepper_motor = {15, 21, 14, 18, false, 0, true, true, DEFAULT_SPEED_Y, DEFAULT_SHIFT_XY};
